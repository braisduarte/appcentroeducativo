...
<div class="container">
    <div class="row">
    <h1 class="col-12">Crear alumno</h1>
        <form action="#" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nif_alumno">NIF</label>
                <input type="text" class="form-control" id="nif_alumno" name="nif_alumno" required>
            </div>
            <div class="form-group">
    ...
    if (isset($_POST['crear'])) {
        ...
        $nombre_imagen = "imagen_alumno_$nif" . $extension_imagen;
